...
export const BollingerChartLoad = () => {
  return new Promise(resolve => {
    fetchChartData( 'BollingerChart.json' )
...
// Based on Mike Bostock's "Line Chart, Bollinger Bands" D3 example
// Copyright 2021 Observable, Inc.
// Released under the ISC license.
// https://observablehq.com/@d3/bollinger-bands
export const BollingerChartDraw = ( data, {
