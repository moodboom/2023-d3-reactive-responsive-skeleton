...
export const TreemapLoad = () => {
  return new Promise(resolve => {
    resolve( fetchChartData( 'Treemap.json' ));
  });
}

// Based on Mike Bostock's "Treemap, CSV" D3 example
// Copyright 2021 Observable, Inc.
// Released under the ISC license.
// https://observablehq.com/@d3/treemap
export const TreemapDraw = ( data, { // data is either tabular (array of objects) or hierarchy (nested objects)
