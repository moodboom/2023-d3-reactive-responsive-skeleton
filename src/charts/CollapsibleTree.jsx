...
export const CollapsibleTreeLoad = () => {
  return new Promise(resolve => {
    resolve( fetchChartData( 'CollapsibleTree.json' ));
  })
}

// Based on Mike Bostock's "Collapsible Tree" D3 example
// Copyright 2020 Observable, Inc.
// Released under the ISC license.
// https://observablehq.com/@d3/collapsible-tree
export const CollapsibleTreeDraw = ( data, {
